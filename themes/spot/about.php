    ...
    <div class="container w">
        <div class="row centered">
            ...
            <div class="col-lg-3">
                ...
                <p class="profile">Voltaire founded Tri-nvent Systems Inc. in 2009 and manages the company since its establishment up to the present.
            ...
            <div class="col-lg-3">
                ...
                <h4>Rey Repe</h4>
                <h5 class="title">Co-Founder</h5>
                <p class="profile">Rey is a visionary, an extremely talented individual with over a decade of industry experience in both hardware and software.
            ...
            <div class="col-lg-3">
                ...
                <h5 class="title">Co-Founder</h5>
                <p class="profile">Ramil started out as an Auditor in trusted and prominent auditing firms in the country.
