...
$this->inc('elements/header.php'); ?>
	...
	<div id="dg">
		<div class="container">
			<div class="row centered">
				...
				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="/themes/spot/assets/img/p01.png" alt=""></a>
					</div>
				</div>

				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="/themes/spot/assets/img/p03.png" alt=""></a>
					</div>
				</div>

				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="/themes/spot/assets/img/p02.png" alt=""></a>
					</div>
				</div>
			</div><!-- row -->
		</div><!-- container -->
    ...
    <script type="text/javascript" src="themes/spot/assets/js/bootstrap.min.js"></script>
