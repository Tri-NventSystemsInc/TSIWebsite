				...
				<div id="container">
					<div id="carousel"  >
						<div id="slide01" class="slide" >
							<!-- <img src="<?= $this->getThemePath(); ?>/images/html_slides/jqueryui.png" src="images/html_slides/jqueryui.png" /> -->
							<div class="text">
						...
						<div id="slide03" class="slide">
							...
							<div class="text">
								<h4>We invsion to be globally recognize as premier customer oriented software Development Company.</h4> 
							</div>
						</div>
